...
train_pipeline = [
    ...
    dict(type='LoadMultiViewImageFromMultiSweepsFiles', sweeps_num=1, 
         to_float32=True, pad_empty_sweeps=True, test_mode=False, sweep_range=[3, 27]),
    ...
    dict(type='Collect3D', keys=['gt_bboxes_3d', 'gt_labels_3d', 'img'],
                    meta_keys=['lidar2img', 'intrinsics', 'extrinsics', 'img_shape', 'pad_shape', 'timestamp',
...
data = dict(
    ...
    test=dict(type=dataset_type, ann_file='data/nuscenes_test/mmdet3d_nuscenes_30f_infos_test_changepath.pkl', pipeline=test_pipeline, classes=class_names, modality=input_modality))
