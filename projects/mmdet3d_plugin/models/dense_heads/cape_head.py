...
class CAPEHead(nn.Module):
    ...
    def __init__(self,
        ...
        if class_weight is not None and (self.__class__ is CAPEHead):
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        if (version is None or version < 2) and self.__class__ is CAPEHead:
            convert_dict = {
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        outs_dec, reference_points = self.transformer(x, masks, I_inv, R_inv, t.squeeze(-1), img_metas)
